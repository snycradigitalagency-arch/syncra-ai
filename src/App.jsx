...
const LandingPage = ({ onNavigate }) => {
  ...
  const chatDemo = [
    ...
    { from: "ai", msg: "Hi there! 👋 The Shea Body Butter is ₦8,500. Currently in stock — smells amazing and moisturizes deeply. Want me to reserve one for you?" },
    { from: "customer", msg: "Can I pay tomorrow?" },
    { from: "ai", msg: "Absolutely! 😊 I'll reserve it for you till tomorrow 6pm. Shall I send you payment details when you're ready?" },
  ];
    ...
    <div style={{ minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <footer style={{ borderTop: `1px solid ${theme.border}`, padding: "40px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 20 }}>
          ...
          <div style={{ color: theme.textMuted, fontSize: 13 }}>© 2025 Syncra AI. Built for Africa. 🌍</div>
...
const OnboardingPage = ({ onNavigate }) => {
  ...
  const categories = [
    { icon: "👗", label: "Fashion & Clothes" }, { icon: "💆‍♀️", label: "Wigs & Hair" },
    { icon: "🌸", label: "Skincare & Beauty" }, { icon: "📱", label: "Gadgets & Tech" },
    { icon: "🍕", label: "Food & Drinks" }, { icon: "👟", label: "Thrift & Vintage" },
    { icon: "💄", label: "Makeup & Cosmetics" }, { icon: "🛍️", label: "General Store" },
  ];
  const tones = [
              ...
              <AnimatePresence>
                {!completing ? (
                  <motion.div key="ready">
                    ...
                    <button className="btn-primary" onClick={handleFinish} style={{ padding: "16px 40px", borderRadius: 14, fontSize: 16 }}>
                      Launch My Dashboard 🚀
                    </button>
                  </motion.div>
                ) : (
